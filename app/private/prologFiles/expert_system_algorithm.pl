...
can_suggest(plan_empresarial, strengthen_leading_experience).
can_suggest(plan_empresarial, learn_leadership).
can_suggest(plan_empresarial, self_managed_team).
...
INPUT => suggest(communication_plan, [quiere_plata, quiere_reconocimiento], [has_savings], [desorganizado], Sugerencias_final).
